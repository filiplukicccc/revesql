...
import HomeMedical from './Medical/HomeMedical'
import HomeTech from './Technologies/HomeTech'
...
export default () => (
  <div>
    ...
    <Switch>
      ...
      <Route exact path='/reves_holding' component={HomeHolding} />
      <Route exact path='/reves_technologies' component={HomeTech} />
      <Route exact path='/reves_medical' component={HomeMedical} />
