			...
			<div>
				<div className={css.navbarDiv}>
					...
					<div className={css.menuStandard} style={{ marginLeft: 'auto', paddingRight: '50px' }}>
						<Menu className={css.menuItem} stackable pointing secondary size='large' style={{ borderBottom: 'none', display: 'flex', jusifyContent: 'center', alignItems: 'center' }}>
							...
							<Link to='/reves_technologies'><Menu.Item style={{ borderBottom: '2px solid #003571' }} name='Reves_technologies' active={activeItem === 'Reves_technologies'} onClick={this.handleItemClick}>REVES Technologies</Menu.Item></Link>
