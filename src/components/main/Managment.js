	...
	render() {
		let arr = [
			...
			},
			{
				...
				picture: square,
				job: 'Founder',
				desc: "After finishing ITAcademy in Belgrade, she begins to work on IT development. After collecting experience in the business field she makes a difficult and an important decision. With great courage, enthusiasm and confidence she manages to start her own IT company Cybele Technologies. After a very short time span the company makes excellent progress both in business and functionality. Most of the work in the company is focused on he business platform development, software design and mobile application development. Besides her business success Jelena's greatest values are courage, determination and the ability to be a step ahead. "
			},
			{
				name: 'Gabriel Nguyen',
				picture: gabriel,
